...
public class WheelView extends View {
	...
	public static int SCROLLING_DURATION = 400;

	/** Minimum delta for scrolling */
	public static final int MIN_DELTA_FOR_SCROLLING = 1;

	/** Current value & label text color */
	public static final int VALUE_TEXT_COLOR = 0xF0000000;

	/** Items text color */
	public static final int ITEMS_TEXT_COLOR = 0xFF000000;

	/** Top and bottom shadows colors */
	public static final int[] SHADOWS_COLORS = new int[] { 0x22111111, 0x00AAAAAA, 0x00AAAAAA };

	/** Additional items height (is added to standard text item height) */
	public static int ADDITIONAL_ITEM_HEIGHT = 30;

	/** Text size */
	public static int TEXT_SIZE = 24;
	/** Top and bottom items offset (to hide that) */
	public static final int ITEM_OFFSET = TEXT_SIZE / 3;

	/** Additional width for items layout */
	public static int ADDITIONAL_ITEMS_SPACE = 15;

	/** Label offset */
	public static  int LABEL_OFFSET = 8;

	/** Left and right padding value */
	public static  int PADDING = 10;

	/** Default count of visible items */
	public static final int DEF_VISIBLE_ITEMS = 8;
	...
	private void initData(Context context) {
        ...
        mTextWidth = FloatMath.ceil(Layout.getDesiredWidth("00", itemsPaint));
        TEXT_SIZE = (int)Utils.convertSpToPixel(18);
	}
    ...
    public String resizeString(String text){

        int maxTextNum = (int)(Math.floor(itemsWidth / mTextWidth));
        if( (maxTextNum) < text.length() ){
            text = text.substring(0,maxTextNum);
            text+="..";
        }
        return text;
    }
